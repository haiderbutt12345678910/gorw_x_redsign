...
class ProfileTech extends StatefulWidget {
  const ProfileTech({super.key});

  @override
  State<ProfileTech> createState() => _ProfileTechState();
}

class _ProfileTechState extends State<ProfileTech> {
